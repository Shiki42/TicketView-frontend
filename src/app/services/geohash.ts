...
class Geohash {
    ...
    static decode(geohash: string): { lat: number; lon: number } {
        ...
        let lat1 = lat.toFixed(Math.floor(2-Math.log(latMax-latMin)/Math.LN10));
        let lon1 = lon.toFixed(Math.floor(2-Math.log(lonMax-lonMin)/Math.LN10));

        return { lat: Number(lat1), lon: Number(lon1) };
    }
     ...
     * @throws  Invalid geohash.
     */
    static bounds(geohash: string): { sw: { lat: number; lon: number }; ne: { lat: number; lon: number } } {
     ...
     * @throws  Invalid geohash.
     */
    static neighbours(geohash: string): { n: string; ne: string; e: string; se: string; s: string; sw: string; w: string; nw: string } {
        return {
